...
| Surface<br>Density | [DENSITY](#__RefHeading___Toc45799_719036256) | [BDENSITY](#__RefHeading___Toc223317_1539708736) | [SDENSITY](#__RefHeading___Toc121471_83452205) | [DENSITY](#__RefHeading___Toc45799_719036256) | [BDENSITY](#__RefHeading___Toc223317_1539708736) |  |  |  |
| [GRAVITY](#__RefHeading___Toc45801_719036256) |  |  | [GRAVITY](#__RefHeading___Toc45801_719036256) |  |  |  |  |  |

| Notes:<br>3)  Cells colored in gray with no mnemonic indicate that there is no keyword for this combination.<br>4)  Cells colored orange show keywords that have not been implemented in OPM Flow for the given fluid type.<br>5)  When two or more keywords are stated for the [RUNSPEC](#__RefHeading___Toc55591_1778172979) keyword for a given fluid type, then all are required to define the given phase.<br>6)  When two keywords are stated for the Pressure Dependent PVT and Miscellaneous data for a given fluid type, then either one can be used to define the PVT behavior for the given phase.<br>7)  OPM Flow specific keywords. |
| --- |
...
| Notes:<br>3)  Cells colored in gray with no mnemonic indicate that there is no keyword for this combination.<br>4)  Cells colored orange show keywords that have not been implemented in OPM Flow.<br>5)  When two or more keywords are stated for the [RUNSPEC](#__RefHeading___Toc55591_1778172979) keyword for a given fluid type, then all are required to define the given phase.<br>6)  When multiple keywords are stated for the Miscellaneous data for a given fluid type, then several keywords can be used to defined the fluid property behavior.<br>7)  [SALINITY](#__RefHeading___Toc405185_1616145207) is OPM Flow specific keyword, that defines the salinity for all cells in the model.<br>8)  [PVTSOL](#__RefHeading___Toc414279_1093985484) is used to model CO~2~ interaction with in situ oil only and is an OPM Flow specific keyword.<br>9)  OPM Flow's implementation of the Microbial Induced Calcite Precipitation (\"MICP\") model used to investigate leakage remediation. All the keywords are specific to OPM Flow.<br>10) OPM Flow has an additional formulation to the standard polymer flooding model, compared to the commercial simulator, known as the Polymer Molecular Weight Transport option, that uses the polymer molecular weight in calculating the polymer viscosity. This model is activated via the [POLYMER](#__RefHeading___Toc38609_2267116897) and [POLYMW](#__RefHeading___Toc38609_22671168971) keywords in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section. The model does not account for non-Newtonian flow; the apparent viscosity is simply set equal to the zero-shear viscosity. Secondly, the standard polymer property data keywords: [PLYROCK](#__RefHeading___Toc110216_2939291539), [PLYADS](#__RefHeading___Toc121087_57619843), [PLYMAX](#__RefHeading___Toc110214_2939291539), etc., are still required to fully describe the polymer fluid. |  |  |  |  |  |
...
| Relative<br>Permeability | [KRO](#__RefHeading___Toc97395_621662414) | Relative permeability of oil at the maximum oil saturation. |
...
| Capillary<br>Pressure | [SWLPC](#__RefHeading___Toc179514_1371377330) | Capillary pressure connate water saturation, that is the lowest water saturation in a water saturation function table to be scaled independently from the [SWL](#__RefHeading___Toc22881_7842323221) relative permeability end-point value. |
...
| Capillary<br>Pressure | [SGLPC](#__RefHeading___Toc170136_1371377330) | Capillary pressure connate gas saturation, that is the smallest gas saturation in a gas saturation function table to be scaled independently from the [SGL](#__RefHeading___Toc22881_784232322) relative permeability end-point value. |
...
| Capillary<br>Pressure | [SWLPC](#__RefHeading___Toc179514_1371377330) | Capillary pressure connate water saturation, that is the smallest water saturation in a water saturation function table to be scaled independently from the [SWL](#__RefHeading___Toc22881_7842323221) relative permeability end-point value. |
...
| Notes:<br>1)  Cells colored in gray with no mnemonic indicate that there is no keyword for this combination.<br>2)  Cells colored orange show keywords that have not been implemented in OPM Flow.<br>3)  In gas-water systems, the gas-water Pcgw data should be entered on the [SWFN](#__RefHeading___Toc106882_335817223) keyword and the Pcog on the [SGFN](#__RefHeading___Toc106868_335817223) keyword should be set to zero.<br>4)  The [SOF2](#__RefHeading___Toc106876_335817223) keyword defines the relative permeability in oil-gas and oil-water runs only, and the miscible hydrocarbon in [SOLVENT](#__RefHeading___Toc62787_1778172979) runs. This keyword should not be used to define the oil relative permeability when oil, gas and water are present.<br>5)  Defines oil relative permeability with respect to water and oil relative permeability with respect to gas.<br>6)  OPM Flow specific keywords that implement the LET family of saturation functions, see Lomeland et al.^[^30].^<br>7)  Format Type Three keywords are available in the commercial compositional simulator only, and will cause an error if used in the commercial black-oil simulator. |  |  |  |  |  |  |  |
...
| --- | --- | --- | --- | --- |
| Oil-Water<br>Oil Leg | Oil-Gas<br>Oil-Leg | Gas-Water<br>Gas Cap | Oil-Gas<br>Gas Cap | Nomenclature<br>LET(S~w~, S~o~, S~g~, n) |
...
| TWAT |  | TOIL |  | TPC |  |
| KRTWAT |  | KRTOIL |  |  |  |
| Notes:<br>1)  The current implementation of the LET functions is restricted to a single branch capillary pressure curves as shown in , and not the multi-branch curve shown in . |  |  |  |  |  |
...
| TGAS |  | TOIL |  | TPC |  |
| KRTGAS |  | KRTOIL |  |  |  |
| Notes:<br>1)  The current implementation of the LET functions is restricted to a single branch capillary pressure curves as shown in , and not the multi-branch curve shown in .<br>2)  The parameter value is taken from the [SWOFLET](#__RefHeading___Toc398954_3017686537) keyword. |  |  |  |  |  |
