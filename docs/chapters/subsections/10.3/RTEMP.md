...
See [[RTEMP - Define the Initial Reservoir Temperature for the Model](#anchor-1)](#7.2.55.RTEMP -Define the Initial Reservoir Temperature for the Model|outline) in the [PROPS](#__RefHeading___Toc39329_784232322) section for a full description.
