...
| 2 | RSNUM | A positive integer that defines the restart point on the [RESTART](#__RefHeading___Toc135629_1317547213) file to be read and to be used to initialize the model.<br>When OPM Flow writes a restart point a message is printed to the \*.PRT file indicating the time step the restart was written out. | None |
| 3 | RSTYPE | A defined character sting set to [SAVE](#__RefHeading___Toc55597_1778172979) to read the restart data from the [SAVE](#__RefHeading___Toc55597_1778172979) file, otherwise defaulted to 1\* to read the data from the [RESTART](#__RefHeading___Toc135629_1317547213) file.<br>The [SAVE](#__RefHeading___Toc55597_1778172979) file option is not supported by OPM Flow and should be defaulted with 1\*. | 1\* |
...
| Notes:<br>1)  OPM Flow can only restart runs from a [RESTART](#__RefHeading___Toc135629_1317547213) file, the commercial simulator\'s [SAVE](#__RefHeading___Toc55597_1778172979) file format is not supported.<br>2)  Note that due to the complexities of the [RESTART](#__RefHeading___Toc135629_1317547213) file, OPM Flow may not always be able to restart from the commercial simulators [RESTART](#__RefHeading___Toc135629_1317547213) file.<br>3)   The keyword is terminated by a "/". |  |  |  |
