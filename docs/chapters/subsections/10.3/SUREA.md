...
| 1 | [SUREA](#__RefHeading___Toc450660_111689907) | [SUREA](#__RefHeading___Toc450660_111689907) is an array of real numbers that are greater than or equal to zero assigning the initial equilibration urea concentration values to each cell in the model.<br>Repeat counts may be used, for example 20\*30.0. | None |
