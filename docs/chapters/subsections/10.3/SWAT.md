...
| 1 | SWAT | SWAT is an array of real positive numbers that are greater than or equal to zero and less than or equal to one assigning the initial equilibration water saturation values to each cell in the model.<br>Repeat counts may be used, for example 20\*0.300. | None |
