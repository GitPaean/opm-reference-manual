...
| 1 | [SOLVFRAC](#__RefHeading___Toc785112_4250154414) | [SOLVFRAC](#__RefHeading___Toc785112_4250154414) is an array of real positive numbers that define the initial solvent fraction within the gas phase values for each matrix cell in the model.<br>Repeat counts may be used, for example 20\*0.075. | None |
