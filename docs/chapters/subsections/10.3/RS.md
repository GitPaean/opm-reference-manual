...
| 1 | [RS](#__RefHeading___Toc137361_1317547213) | [RS](#__RefHeading___Toc137361_1317547213) is an array of real positive numbers assigning the initial equilibration gas-oil ratio values to each cell in the model.<br>Repeat counts may be used, for example 20\*1.30. | None |
