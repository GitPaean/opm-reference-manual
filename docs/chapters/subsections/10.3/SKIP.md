...
See [[SKIP -- Activate Skipping of All Keywords and Input Data](#anchor-1)](#3.1.11.SKIP – Activate Skipping of All Keywords and Input Date|outline) in the GLOBAL section for a full description.
