...
| 1 | PDEW | PDEW is an array of real positive numbers assigning the initial equilibration dew-point pressure values to each cell in the model.<br>Repeat counts may be used, for example 20\*3525.0 | None |
| psia | barsa | atma |  |
