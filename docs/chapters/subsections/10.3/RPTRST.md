...
| 8 | [FIP](#__RefHeading___Toc250560_252421755) | Volumes in place for each phase at surface conditions. | FIPGAS<br>FIPOIL<br>FIPWAT |
| 9 | FLOWS | Inter-block volumetric flows at surface conditions for each phase ([GAS](#__RefHeading___Toc38607_2267116897), [OIL](#__RefHeading___Toc97439_1778172979), WAT) in the I+, J+ and K+ directions. The Array Name column shows the arrays for just the [GAS](#__RefHeading___Toc38607_2267116897) phase, the other phases will have similar arrays. | FLOGASI+<br>FLOGASJ+<br>FLOGASK+ |
| 10 | FLOWS- | Inter-block volumetric flows at surface conditions for each phase ([GAS](#__RefHeading___Toc38607_2267116897), [OIL](#__RefHeading___Toc97439_1778172979), WAT) in the I-, J- and K- directions. The Array Name column shows the arrays for just the [GAS](#__RefHeading___Toc38607_2267116897) phase, the other phases will have similar arrays. | FLOGASI-<br>FLOGASJ-<br>FLOGASK- |
| 11 | FLORES | Inter-block volumetric flows at reservoir conditions for each phase ([GAS](#__RefHeading___Toc38607_2267116897), [OIL](#__RefHeading___Toc97439_1778172979), WAT) in the I+, J+ and K+ directions. The Array Name column shows the arrays for just the [GAS](#__RefHeading___Toc38607_2267116897) phase, the other phases will have similar arrays. | FLRGASI+<br>FLRGASJ+<br>FLRGASK+ |
| 12 | FLORES- | Inter-block volumetric flows at reservoir conditions for each phase ([GAS](#__RefHeading___Toc38607_2267116897), [OIL](#__RefHeading___Toc97439_1778172979), WAT) in the I-, J- and K- directions. The Array Name column shows the arrays for just the [GAS](#__RefHeading___Toc38607_2267116897) phase, the other phases will have similar arrays. | FLRGASI-<br>FLRGASJ-<br>FLRGASK- |
...
| 17 | PBPD | Bubble point and dew point pressures. | [PBUB](#__RefHeading___Toc135619_1317547213)<br>[PDEW](#__RefHeading___Toc135623_1317547213) |
...
Note, older versions of the commercial simulator used integer values to control the output to the [RESTART](#__RefHeading___Toc135629_1317547213) file, this type of format is not supported by OPM Flow and thus the integers should be converted to the mnemonic format as outlined in .
...
| 28 | [TEMP](#__RefHeading___Toc146397_3544483072) | Temperature of each grid block used when the [THERMAL](#__RefHeading___Toc137276_650382403) option has been activated in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.<br>OPM Flow also supports the output of temperatures for non-thermal simulations when the [TEMP](#__RefHeading___Toc146397_3544483072) mnemonic is specified. | [TEMP](#__RefHeading___Toc146397_3544483072) |
...
| Notes:<br>3)  Only items that are necessary to restart a run are written to the restart file, for example if the [SOLVENT](#__RefHeading___Toc62787_1778172979) option has not been activated in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section then the SSOLVENT array will not be written to the restart file.<br>4)  The tracer distribution is output when the [TRACERS](#__RefHeading___Toc76509_327352552) option has been activated in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section. The array name is the tracer name followed by either \'F\' (free) or \'S\' (solution). |  |  |  |
...
| Notes:<br>3)  The above OPM Flow specific data are only written to the restart file if the \--enable-opm-rst-file=true command line option has been specified and the specified options have been activated in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section. |  |  |  |
