...
| 1 | [SOLVCONC](#__RefHeading___Toc771984_4250154414) | [SOLVCONC](#__RefHeading___Toc771984_4250154414) is an array of real positive numbers that define the initial equilibration coal solvent concentration values to each matrix cell in the model.<br>Repeat counts may be used, for example 20\*75.0. | None |
