...
| 1 | [RV](#__RefHeading___Toc137365_1317547213) | [RV](#__RefHeading___Toc137365_1317547213) is an array of real positive numbers assigning the initial equilibration vaporized oil-gas ratio values to each cell in the model.<br>Repeat counts may be used, for example 20\*0.00720 | None |
