...
| --- | --- | --- | --- |
| feet | m | cm |  |
| 2 | PRESS | PRESS is a single positive value that defines the pressure at [DATUM](#__RefHeading___Toc135613_1317547213).<br>If the DATUM depth lies above the GOC then PRESS is the pressure with respect to the gas phase. If the DATUM depth is below OWC then PRESS refers to the water phase pressure. Otherwise, PRESS refers to the oil phase pressure. | 0.0 |
| psia | barsa | atma |  |
...
| psia | barsa | atma |  |
| 7 | EQLOPT1 | EQLOPT1 is an integer value that sets the initialization option for when dissolved gas is present in the run, as activated by the [DISGAS](#__RefHeading___Toc39767_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.<br>1)  A positive value of EQLOPT1 results in the gas-oil ratio being calculated from data entered on the [PBVD](#__RefHeading___Toc135621_1317547213) (saturation pressure or bubble-point pressure versus depth table) or the [RSVD](#__RefHeading___Toc137363_1317547213) keyword (gas-oil ratio versus depth table). If this option is selected, then either the [PBVD](#__RefHeading___Toc135621_1317547213) or [RSVD](#__RefHeading___Toc137363_1317547213) keywords must be present in the input deck.<br>2)  Note that the allocation of multiple [PBVD](#__RefHeading___Toc135621_1317547213) and [RSVD](#__RefHeading___Toc137363_1317547213) tables to each grid cell is through the [EQLNUM](#__RefHeading___Toc73734_2752266063) keyword and not the [PVTNUM](#__RefHeading___Toc68366_2752266063) keyword.<br>3)  A zero value of EQLOPT1 results in the gas-oil ratio being set to the saturated gas-oil ratio at the GOC. In this case DATUM must be equal GASCONT and the [PBVD](#__RefHeading___Toc135621_1317547213) and [RSVD](#__RefHeading___Toc137363_1317547213) keywords may be omitted.<br>4)  A negative value of EQLOPT1 results in the same option for when EQLOPT1 is zero.<br>EQLOPT1 is ignored if there is no dissolved gas in the run. | 0 |
| dimensionless | dimensionless | dimensionless |  |
| 8 | EQLOPT2 | EQLOPT2 is an integer value that sets the initialization option for when vaporized oil (condensate) is present in the run, as activated by the [VAPOIL](#__RefHeading___Toc56610_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.<br>1)  A positive value of EQLOPT2 results in the condensate-gas ratio being calculated from data entered on the [PDVD](#__RefHeading___Toc135625_1317547213) (saturation pressure or dew point pressure versus depth table) or the [RVVD](#__RefHeading___Toc137367_1317547213) keyword (condensate-gas ratio versus depth table). If this option is selected, then either the [PDVD](#__RefHeading___Toc135625_1317547213) or [RVVD](#__RefHeading___Toc137367_1317547213) keywords must be present in the input deck<br>2)  Note that the allocation of multiple [PDVD](#__RefHeading___Toc135625_1317547213) and [RVVD](#__RefHeading___Toc137367_1317547213) tables to each grid cell is through the [EQLNUM](#__RefHeading___Toc73734_2752266063) keyword and not the [PVTNUM](#__RefHeading___Toc68366_2752266063) keyword.<br>3)  A zero value of EQLOPT2 results in the condensate-gas ratio being set to the saturated condensate-gas ratio at the GOC. In this case DATUM must be equal GASCONT and the [PDVD](#__RefHeading___Toc135625_1317547213) and [RVVD](#__RefHeading___Toc137367_1317547213) keywords may be omitted.<br>4)  A negative value of EQLOPT2 results in the same option for when EQLOPT2 is zero.<br>EQLOPT2 is ignored if there is no vaporized oil in the run. | 0 |
| dimensionless | dimensionless | dimensionless |  |
