...
Here the GASFTARG keyword sets a minimum target rate in the calculated final pass monthly gas rates and thus equation become:
...
GASFTARG~month~ = minimum monthly gas rate target.
