...
| 1 | LGRNAME | A character string of up to eight characters in length that defines the LGR name for which the LGR is being deactivated.<br>The LGR must have been previously defined by the CARFIN (Cartesian LGR grid) or RADIN/RADIN4 (radial LGR grid) keywords in the GRID section. | None |
| --- | --- | --- | --- |
