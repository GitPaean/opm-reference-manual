...
See [[PLYMAX - Define Polymer-Salt Viscosity Mixing Concentrations](#anchor-1)](#7.2.37.PLYMAX - Define Polymer-Salt Viscosity Mixing Concentrations|outline) in the [PROPS](#__RefHeading___Toc39329_784232322) section for a full description.
