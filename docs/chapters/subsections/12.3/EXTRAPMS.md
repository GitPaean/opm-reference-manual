...
See [[EXTRAPMS -- Activate Extrapolation Warning Messages](#anchor-1)](#3.1.6.EXTRAPMS – Activate Extrapolation Warning Messages|outline) in the GLOBAL section for a full description.
