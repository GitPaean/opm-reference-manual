...
| 1 | [VFPTABL](#__RefHeading___Toc647382_487874538) | [VFPTABL](#__RefHeading___Toc647382_487874538) is a defined positive integer that specifies the interpolation method to be used with the ALQ quantity in the VFP production tables, and should be set to one of the following:<br>1)  Apply linear interpolation to all [VFPPROD](#__RefHeading___Toc121919_2556401936) variables.<br>2)  Apply linear interpolation to all [VFPPROD](#__RefHeading___Toc121919_2556401936) variables, except for the ALQ variable, for which cubic spline interpolation should be used.<br>```{=html} <!-- --> ``` 1)  If the keyword is absent from the input deck then linear interpolation will be used for all variables. | 1 |
