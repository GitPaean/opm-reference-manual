...
In OPM Flow, [VAPPARS](#__RefHeading___Toc210172_2884651453) can only be set once, and not changed multiple times in the [SCHEDULE](#__RefHeading___Toc43945_784232322) section.

See [[VAPPARS -- Oil Vaporization Parameters](#anchor-1)](#9.2.29.VAPPARS – Oil Vaporization Parameters|outline) in the [SOLUTION](#__RefHeading___Toc43947_784232322) section for a full description.
