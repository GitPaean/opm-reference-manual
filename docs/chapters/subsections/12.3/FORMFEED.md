...
See [[FORMFEED -- Defined the Print File Form-Feed Character](#anchor-1)](#4.1.8.FORMFEED – Defined the Print File Form-Feed Character|outline) in the GLOBAL section for a dull description.
