...
See [[DIFFMMF -- Define Diffusivity Multipliers for Matrix-Fractures](#anchor-1)](#8.3.24.DIFFMMF – Define Diffusivity Multipliers for Matrix-Fractures|outline) in the [GRID](#__RefHeading___Toc38674_784232322) section for a full description.
