...
| 1 | LX | LX is an array of real numbers describing the "representative" cell size in the X direction for each cell in the model.<br>Repeat counts may be used, for example 10\*100.0. | 0 |
| feet | m | cm |  |
