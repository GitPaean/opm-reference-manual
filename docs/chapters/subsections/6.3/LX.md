...
| 1 | [LX](#__RefHeading___Toc499449_3181922006) | [LX](#__RefHeading___Toc499449_3181922006) is an array of real numbers describing the "representative" cell size in the X direction for each cell in the model.<br>Repeat counts may be used, for example 10\*100.0. | 0 |
| feet | m | cm |  |
