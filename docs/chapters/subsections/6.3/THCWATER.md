...
| 1 | [THCWATER](#__RefHeading___Toc323954_1728001293) | [THCWATER](#__RefHeading___Toc323954_1728001293) is an array of real positive numbers that define the thermal conductivity of the water phase in each grid block.<br>Repeat counts may be used, for example 3000\*20.0 | None |
