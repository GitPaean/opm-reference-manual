...
| 1 | [DZV](#__RefHeading___Toc55601_3701168388) | [DZV](#__RefHeading___Toc55601_3701168388) is a vector of real numbers describing the cell size for the grid blocks in the Z direction.<br>Repeat counts may be used, for example 10\*20.0. | None |
| feet | m | cm |  |
| Notes:<br>1)  The number of entries should correspond to the NZ parameter on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section..<br>2)  The keyword is terminated by a "/". |  |  |  |
