...
| 1 | [DTHETA](#__RefHeading___Toc120096_2066951158) | [DTHETA](#__RefHeading___Toc120096_2066951158) is an array of real numbers describing the cell size in the THETA direction in radial grids for each cell in the model.<br>Repeat counts may be used, for example 10\*25.0 | None |
