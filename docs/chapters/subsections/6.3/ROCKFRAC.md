...
| Notes:<br>1)  Setting a cells [ROCKFRAC](#__RefHeading___Toc699968_501926209) value to zero will make the cell inactive, similar to setting the cells [ACTNUM](#__RefHeading___Toc4410_421927891) property to zero.<br>2)  The keyword is terminated by a "/". |  |  |  |
