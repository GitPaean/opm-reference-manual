...
| --- | --- | --- | --- |
| 1 | [SMULTY](#__RefHeading___Toc1275012_516898843)+ | [SMULTY](#__RefHeading___Toc1275012_516898843)+ is an array of real positive numbers assigning the transmissibility multipliers in the +X direction to each cell face in the model.<br>Repeat counts may be used, for example 20\*100.0. | 1.0 |
