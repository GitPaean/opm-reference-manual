...
| --- | --- | --- | --- |
| 1 | [MULTR-](#__RefHeading___Toc80285_17781729792) | [MULTR-](#__RefHeading___Toc80285_17781729792) is an array of real positive numbers assigning the transmissibility multipliers in the -R direction to each cell face in the model.<br>Repeat counts may be used, for example 20\*100.0. | 1.0 |
