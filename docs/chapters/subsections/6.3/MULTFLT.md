...
| 3 | FLT-DIF | A positive real number that sets the diffusivity multiplier to be applied to the FLTNAME diffusivities.<br>This option should only be used if the Diffusion option has been made activate by the [DIFFUSE](#__RefHeading___Toc349951_1539708736) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.<br>OPM Flow does not support this Diffusion option. | 1.0 |
