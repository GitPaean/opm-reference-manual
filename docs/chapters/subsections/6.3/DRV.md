...
| 1 | [DRV](#__RefHeading___Toc91991_705534506) | [DRV](#__RefHeading___Toc91991_705534506) is a vector of real numbers describing the cell size for the grid blocks in the R direction in a radial grid.<br>Repeat counts may be used, for example 10\*100.0. | None |
| feet | m | cm |  |
| Notes:<br>1)  The number of entries should correspond to the NX parameter on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section<br>2)  The keyword is terminated by a "/". |  |  |  |
