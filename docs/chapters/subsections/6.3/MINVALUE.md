...
| 2 | CONSTANT | CONSTANT is a positive integer or positive real value that an ARRAY element will be reset to if an element in the defined input [BOX](#__RefHeading___Toc42110_3671211675), as defined by items (3) to (8), is less than CONSTANT.<br>CONSTANT has in the same units as the ARRAY property. | None |
