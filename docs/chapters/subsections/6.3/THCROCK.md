...
| 1 | [THCROCK](#__RefHeading___Toc124825_650382403) | [THCROCK](#__RefHeading___Toc124825_650382403) is an array of real positive numbers that define the thermal conductivity of the reservoir rock in each grid block.<br>Repeat counts may be used, for example 3000\*20.0 | None |
