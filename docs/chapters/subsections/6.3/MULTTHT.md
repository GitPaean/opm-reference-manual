...
| --- | --- | --- | --- |
| 1 | [MULTTHT](#__RefHeading___Toc270099_1841740821)+ | [MULTTHT](#__RefHeading___Toc270099_1841740821)+ is an array of real positive numbers assigning the transmissibility multipliers in the +Theta direction to each cell face in the model.<br>Repeat counts may be used, for example 20\*100.0. | 1.0 |
