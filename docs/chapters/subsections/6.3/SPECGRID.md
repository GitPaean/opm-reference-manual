...
| 4 | [NUMRES](#__RefHeading___Toc81021_4106839650) | A positive integer values that defines number of coordinate data sets, or independent reservoirs in the model.<br>OPM Flow currently only accepts a single data set, that is the default value of one. | 1 |
...
| Notes:<br>1)  The dimensions are also entered on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section and the two sets of numbers should be consistent.<br>2)  The keyword is terminated by a "/". |  |  |  |
