...
| 1 | [DX](#__RefHeading___Toc92905_705534506) | [DX](#__RefHeading___Toc92905_705534506) is an array of real numbers describing the cell size in the X direction for each cell in the model.<br>Repeat counts may be used, for example 10\*100.0. | None |
| feet | m | cm |  |
