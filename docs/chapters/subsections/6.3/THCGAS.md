...
| 1 | [THCGAS](#__RefHeading___Toc93091_718313858) | [THCGAS](#__RefHeading___Toc93091_718313858) is an array of real positive numbers that define the thermal conductivity of the gas phase in each grid block.<br>Repeat counts may be used, for example 3000\*20.0 | None |
