...
| 12 | HOSTNAME | A character string of up to eight characters in length that defines the host grid name for nested refinements. The default value of "GLOBAL" sets the host name to the global grid, that is for a conventional [LGR](#__RefHeading___Toc55049_4106839650).<br>A nested refinement is when the HOSTNAME is a previously declared [LGR](#__RefHeading___Toc55049_4106839650) for which the current [LGR](#__RefHeading___Toc55049_4106839650) is specifying a further [LGR](#__RefHeading___Toc55049_4106839650) refinement. | GLOBAL |
