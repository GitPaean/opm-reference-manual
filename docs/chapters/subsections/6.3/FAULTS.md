...
| 8 | FLTFACE | FLTFACE is a character string enclosed in quotes with a maximum length of two characters, that classifies the fault face.<br>1)  If TRANSMULT on the [GRIDOPTS](#__RefHeading___Toc45741_719036256) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section is set to NO then FLTFACE can have values of X, Y, or Z.<br>2)  Alternatively, if TRANSMULT on the [GRIDOPTS](#__RefHeading___Toc45741_719036256) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section is set to YES then FLTFACE can have values of X, Y, or Z for the positive direction, or X-, Y- or Z- for the negative direction transmissibilities. | None |
| Notes:<br>1)  Where NX, NY and NZ are the dimensions of the model as defined on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.<br>2)  The [FAULTDIM](#__RefHeading___Toc28917_1640804870) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) defines the maximum number of records (or segments) that can be entered with the [FAULTS](#__RefHeading___Toc45779_719036256) keyword.<br>3)  Each record must be terminated by a "/" and the keyword is terminated by a "/". |  |  |  |
