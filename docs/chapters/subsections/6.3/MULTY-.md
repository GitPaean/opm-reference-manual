...
| --- | --- | --- | --- |
| 1 | MULTY- | MULTY- is an array of real positive numbers assigning the transmissibility multipliers in the -Y direction to each cell face in the model.<br>Repeat counts may be used, for example 20\*100.0. | 1.0 |
