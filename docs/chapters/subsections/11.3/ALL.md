...
| > Notes:                                                                                                                                                                                 |        |         |         |        |                                                             |
|                                                                                                                                                                                          |        |         |         |        |                                                             |
| 1)  Cells colored in gray indicate that the summary variable is not available for this combination.                                                                                      |        |         |         |        |                                                             |
|                                                                                                                                                                                          |        |         |         |        |                                                             |
| 2)  Cells colored orange under the Type column indicate that this set of summary variables are not available in OPM Flow because the underlying feature is not available in OPM Flow.    |        |         |         |        |                                                             |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------+---------+---------+--------+-------------------------------------------------------------+
