...
| 1 | [TRANR](#__RefHeading___Toc1306688_4250154414) | [TRANR](#__RefHeading___Toc1306688_4250154414) is an array of real positive numbers assigning the transmissibility in the R direction to each cell in the model.<br>Repeat counts may be used, for example 20\*100.0. | None |
