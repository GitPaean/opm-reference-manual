...
See [[MULTREGP -- Multiply Pore Volumes Based On Region Number](#anchor-1)](#5.3.35.MULTREGP– Multiply Pore Volumes Based On Region Number|outline) in the [GRID](#__RefHeading___Toc38674_784232322) section for a full description.
