...
| 1 | TRANZ | TRANZ is an array of real positive numbers assigning the transmissibility in the Z direction to each cell in the model.<br>Repeat counts may be used, for example 20\*100.0. | None |
