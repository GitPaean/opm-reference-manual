...
| 1 | [PORV](#__RefHeading___Toc96547_718313858) | [PORV](#__RefHeading___Toc96547_718313858) is an array of real positive numbers assigning a pore volume to each cell in the model. Only the values in the currently defined input [BOX](#__RefHeading___Toc42110_3671211675) needed be entered.<br>Repeat counts may be used, for example 20\*100.0. | None |
| rb | rm^3^ | rcc |  |
