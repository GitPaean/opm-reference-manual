...
See [[REFINE -- Start the Definition of a Local Grid Refinement](#anchor-1)](#6.3.81.RADFIN – Define a Radial Local Grid Refinement with One Column|outline) in the [GRID](#__RefHeading___Toc38674_784232322) section for a full description.
