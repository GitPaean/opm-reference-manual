...
The SOLVDIMS defines the unstructured Perpendicular Bisector ("PEBI")[^1] and [^2] grid nested factorization solver dimensions. This keyword is generated by an external pre-processing program for generating simulation grids.
