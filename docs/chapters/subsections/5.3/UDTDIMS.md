...
+-------------------------------------------+----------+------------------------------------------------------------------------------------------------------------------------+-----+
| > 4                                       | > MXDIMS | > MXDIMS is a positive integer that defines the maximum number of dimensions in any given User Defined Table.          | > 0 |
|                                           |          |                                                                                                                        |     |
|                                           |          | > Only one dimensional tables are currently supported by OPM Flow.                                                     |     |
+-------------------------------------------+----------+------------------------------------------------------------------------------------------------------------------------+-----+
| > Notes:                                  |          |                                                                                                                        |     |
|                                           |          |                                                                                                                        |     |
