...
| 6 | NRPVT | A positive integer that defines the maximum number of Rs and Rv entries in the PVT tables.<br>If the [DISGAS](#__RefHeading___Toc39767_2267116897) and [VAPOIL](#__RefHeading___Toc56610_2267116897) options have not been activated then this parameter is ignored. | 20 |
...
| Notes:<br>1)  Table sets are groups of keywords that need to be defined to complete a table set. For example if NTPVT is set to three, then there must be three [PVTO](#__RefHeading___Toc104062_57619843) tables and three [PVTG](#__RefHeading___Toc104060_57619843) tables to complete the three PVT data set.<br>2)  The keyword is terminated by a "/". |  |  |  |
