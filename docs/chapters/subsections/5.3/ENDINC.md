...
See [[ENDINC -- Define the End of an Include File](#anchor-1)](#3.1.4.ENDINC – Defines the End of an Include File|outline) in the GLOBAL section for a full description.
