...
| --- | --- | --- | --- |
| 1 | NUMRES | A positive integer that defines the number of [COORD](#__RefHeading___Toc45757_719036256) data sets to be processed by OPM Flow.<br>OPM Flow currently only supports a single reservoir grid and so this item should be defaulted (1\*) or set to one. | 1 |
