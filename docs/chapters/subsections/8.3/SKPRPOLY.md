...
| psia | barsa | atma |  |
| Notes:<br>1)  The keyword should be terminated by a "/", but may be repeated up to NTSKPOLY times, as per the [PINTDIMS](#__RefHeading___Toc637730_5168988431) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section, to allow for the input of multiple tables. |  |  |  |
