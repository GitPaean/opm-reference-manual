...
| psia | barsa | atma |  |
| 2 | WATJTC | WATJTC is a real positive or negative value that defines the water phase Joule-Thomson Coefficient.<br>If the value is defaulted (1\*) or set to 0, then WATJTC is internally calculated using thermal water density data on the WATSDENT keyword in the [PROPS](#__RefHeading___Toc39329_784232322) section.<br>If a non-zero value is specified, then the WATJTC is assumed to be constant and equal to that value. | 0 |
