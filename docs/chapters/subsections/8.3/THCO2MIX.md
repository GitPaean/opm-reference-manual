...
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 1)  NONE: pure water enthalpy will be used, or                                                                                                        |               |
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 2)  MICHAELIDES: account for salt concentration according to Michaelides[^1], 1981.                                                                   |               |
+-------------------------------------------+-----------+-------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
...
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 1)  NONE: do not account for CO~2~ in brine,                                                                                                          |               |
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 2)  IDEAL: account for CO~2~ assuming an ideal mixture (based on mass fractions), or                                                                  |               |
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 3)  DUANSUN: also add the heat of dissolution for CO~2~ according to Dun and Sun[^2], 2003 (Fig. 6).                                                  |               |
+-------------------------------------------+-----------+-------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
...
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 1)  NONE: pure CO~2\ ~enthalpy will be used, or                                                                                                       |               |
|                                           |           |                                                                                                                                                       |               |
|                                           |           | 2)  IDEAL: account for vaporized water assuming an ideal mixture (based on mass fractions).                                                           |               |
+-------------------------------------------+-----------+-------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+
| > Notes:                                  |           |                                                                                                                                                       |               |
|                                           |           |                                                                                                                                                       |               |
