...
| 1 | SKRO | SKRO is an array of positive real numbers which are greater than zero and less than or equal to 1.0, that are the assigned scaling SKRO values for each cell in the model.<br>Repeat counts may be used, for example 50\*0.500. | Taken from cell allocated relative permeability table. |
