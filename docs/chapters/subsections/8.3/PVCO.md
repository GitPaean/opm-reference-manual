...
|                                                                                                                                                                                                                       |                                              |                                                                                                                                                                                                                                                                                            |        |
| 2)  Items (2) to (6) may be defaulted, in which case linear interpolation will be used to calculate the missing values. In addition, OVISCOMP, item (6),may be completely defaulted, which sets this data to zero.    |                                              |                                                                                                                                                                                                                                                                                            |        |
|                                                                                                                                                                                                                       |                                              |                                                                                                                                                                                                                                                                                            |        |
