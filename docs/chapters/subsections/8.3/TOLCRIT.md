...
See also section [8.2.4](#anchor-2)[Saturation Tables (Relative Permeability and Capillary Pressure Tables)](#anchor-2) for a description of the relative permeability tables and the various end-point definitions, including oil, water and gas critical saturations.
