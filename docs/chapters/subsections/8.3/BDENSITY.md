...
| WATDEN is a real monotonically increasing positive row vector that defines the brine density at surface conditions for the given salt concentrations on the corresponding [PVTWSALT](#__RefHeading___Toc331848_501926209) keyword in the [PROPS](#__RefHeading___Toc39329_784232322) section.<br>There should be one row element for each salt concentration columnar element (SALTCON) on the [PVTWSALT](#__RefHeading___Toc331848_501926209) keyword. |  |  |  |  |  |
| lb/ft^3^ | kg/m | gm/cc |  |  |  |
