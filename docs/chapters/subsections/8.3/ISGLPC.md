...
| 1 | [ISGLPC](#__RefHeading___Toc170134_1371377330) | [ISGLPC](#__RefHeading___Toc170134_1371377330) is an array of real numbers assigning the connate gas saturation values to each cell in the model. The number of entries should correspond to the NX x NY x NZ parameters on the [DIMENS](#__RefHeading___Toc20387_2267116897) keyword.<br>If [ISGLPC](#__RefHeading___Toc170134_1371377330) is omitted from the input deck the values will be defaulted to those on the [ISGL](#__RefHeading___Toc22881_7842323222) series of keywords. If the [ISGL](#__RefHeading___Toc22881_7842323222) series of keywords are missing from the input deck then the values are taken from the cell allocated capillary pressure table.<br>Repeat counts may be used, for example 30\*0.03 | Taken from [SGL](#__RefHeading___Toc22881_784232322) or from the cell allocated capillary pressure table. |
