...
| --- | --- | --- | --- |
| 1 | OILZONE | OILZONE is a single character that sets the oil phase transition zone end-point scaling option and should be set to either T or F:<br>1)  T: for true, results in the [SOWCR](#__RefHeading___Toc30436_784232322) values being adjusted to the initial immobile saturation for oil-water or oil-water-miscible gas simulations. For oil-gas simulations the [SOGCR](#__RefHeading___Toc30434_784232322) values are modified to be the initial immobile saturation. The modifications only occur in cells where the initial saturation is below the entered critical saturation.<br>2)  F: for false, means the critical saturations are not modified. | F |
| 2 | WATZONE | WATZONE is a single character that sets the water phase transition zone end-point scaling option and should be set to either T or F:<br>1)  T: for true, results in the [SWCR](#__RefHeading___Toc27248_784232322) values being adjusted to the initial immobile saturations. The modifications only occur in cells where the initial saturation is below the entered critical saturation values ([SWCR](#__RefHeading___Toc27248_784232322)).<br>2)  F: for false, means the critical saturations are not modified. | F |
| 3 | GASZONE | GASZONE is a single character that sets the gas phase transition zone end-point scaling option and should be set to either T or F:<br>1)  T: for true, results in the [SGCR](#__RefHeading___Toc20428_784232322) values being adjusted to the initial immobile saturation for oil-gas or gas-water simulations. The modifications only occur in cells where the initial saturation is below the entered critical saturation ([SGCR](#__RefHeading___Toc20428_784232322)).<br>2)  F: for false, means the critical saturations are not modified. | F |
