...
See [Error: Reference source not found](#anchor-2) in the SOLUTION section, as the keyword is documented in the SOLUTION section, the same as the commercial simulator, but it can also be used in the PROPS section by OPM Flow.
