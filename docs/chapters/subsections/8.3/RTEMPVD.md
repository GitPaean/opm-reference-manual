...
See [[Error: Reference source not found](#anchor-2)](#9.2.3.RTEMPVD - Define the Initial Reservoir Temperature versus Depth Tables|outline) in the [SOLUTION](#__RefHeading___Toc43947_784232322) section, as the keyword is documented in the [SOLUTION](#__RefHeading___Toc43947_784232322) section, the same as the commercial simulator, but it can also be used in the [PROPS](#__RefHeading___Toc39329_784232322) section by OPM Flow.
