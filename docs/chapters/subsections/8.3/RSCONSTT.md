...
| psia | barsa | atma |  |
| Notes:<br>1)  The keyword is followed by NTPVT rows as declared on the [TABDIMS](#__RefHeading___Toc89327_327352552) keyword in the [RUNSPEC](#__RefHeading___Toc55591_1778172979) section.<br>2)  Each row must contain two values representing the [RS](#__RefHeading___Toc137361_1317547213) and PRESS variables.<br>3)  Each row is terminated by a "/" and there is no "/" terminator for the keyword. |  |  |  |
