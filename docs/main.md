...
| Company |  |  |  |
| --- | --- | --- | --- |
| Confidentiality,<br>copyright and<br>reproduction | This document is Copyright 2025 by the team.<br>Documentation Contributors and Developers: |  |  |
...
|  |  |  |  |
| One may distribute or modify the document under the terms of the Creative Commons Attribution-ShareALike 4.0 International License, version 4.0 or later (http://creativecommons.org/licenses/by/4.0/).<br>All trademarks within this guide belong to their legitimate owners. |  |  |  |
| Document Type |  |  |  |
| Document Title | () |  |  |
| Document Version |  |  |  |
| Document Ref. |  |  |  |
| Author and Editor | OPM-OP AS<br>Oscars Gate 27, 0352 Oslo, Norway |  |  |
